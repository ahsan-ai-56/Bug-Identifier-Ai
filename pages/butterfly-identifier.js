  ...
  return (
    <>
      ...
      <section className="hero page-hero">
        <div className="hero-bg" style={{ backgroundImage: "url(\'https://images.unsplash.com/photo-1504700610630-ac6aba3536d3?w=1600&q=80\')" }} />
      ...
      <section className="section sec-white">
        <div className="container prose">
          ...
          <img src="https://images.unsplash.com/photo-1504700610630-ac6aba3536d3?w=1600&q=80" alt="Butterfly identification using AI" className="prose-img" />
